...
func TestExtractSessionsFromNode_NilNode(t *testing.T) {
	sessions := extractSessionsFromNode(nil, "window-1", "tab-1")
	if sessions != nil {
...
func TestExtractSessionsFromNode_EmptyNode(t *testing.T) {
	...
	sessions := extractSessionsFromNode(node, "window-1", "tab-1")
	if len(sessions) != 0 {
...
func TestExtractSessionsFromNode_WithNestedNode(t *testing.T) {
	...
	sessions := extractSessionsFromNode(parentNode, "window-1", "tab-1")
