...
// session management, and access to advanced iTerm2 features. It's designed
// for both interactive use and scripting workflows.
//
// # Installation
//
...
//
// Commands automatically normalize session IDs and fall back to
// $ITERM_SESSION_ID when appropriate, making current session operations seamless.
//
// # Output Formats
//
...
//   - Project repository: https://github.com/tmc/it2
